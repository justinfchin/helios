...
from LPC import lpc
from train_females import training
import os
...
Test5: Use eight sa5.wav files to test trained speakers (same file testing for all)
...
for i,wave_file in enumerate(wave_files):
    fname = '/' + wave_file
    to_print = 'Test female speaker ['+ str(i) + ']   File:' + wave_file + '    Testing features...'
    print to_print
...
directory = os.getcwd() + '/line1_female'
wave_files = [f for f in os.listdir(directory)]
nSpeaker = len(wave_files)
#Reset counters
nCorrect_MFCC = 0
...
#Get new *.wav testing files and change directory
directory = os.getcwd() + '/line2_female'
wave_files = [f for f in os.listdir(directory)]
nSpeaker = len(wave_files)
#Reset counters
nCorrect_MFCC = 0
...
#Get new *.wav testing files and change directory
directory = os.getcwd() + '/line3_random_female'
wave_files = [f for f in os.listdir(directory)]
nSpeaker = len(wave_files)
#Reset counters
nCorrect_MFCC = 0
...
#Get new *.wav testing files and change directory
directory = os.getcwd() + '/line4_fake_female'
wave_files = [f for f in os.listdir(directory)]
nSpeaker = len(wave_files)
#Reset counters
nCorrect_MFCC = 0
